...
import {Modal, Box, TextInput, rem, PasswordInput, Button, Group, Alert, Transition, Divider, Title} from '@mantine/core';
                    ...
                    <form onSubmit={handleSubmit((data)=>{handleRegister(data)})}>
                        ...
                        <Transition
                            ...
                            timingFunction="ease">
                                {(styles) => 
                                <div style={styles}>
                                    <Alert variant="light" color="red" title="Problem with signup" icon={<IconInfoCircle />}>
                                        {invalid.message}
                                    </Alert>
                                </div>}
                        </Transition>
